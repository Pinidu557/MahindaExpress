...
// Create a separate API client for staff endpoints that don't use the /api prefix
...
export const staffApi = {
  list: (params) =>
    staffApiClient.get("/staff", { params }).then((r) => r.data),
  create: (data) => staffApiClient.post("/staff", data).then((r) => r.data),
  get: (id) => staffApiClient.get(`/staff/${id}`).then((r) => r.data),
  update: (id, data) =>
    staffApiClient.put(`/staff/${id}`, data).then((r) => r.data),
  remove: (id) => staffApiClient.delete(`/staff/${id}`).then((r) => r.data),
  addOvertime: (id, hours) =>
    staffApiClient.put(`/staff/overtime/${id}`, { hours }).then((r) => r.data),
  assignBus: (id, busId) =>
    staffApiClient
      .put(`/staff/assign/${id}`, { assignedBus: busId })
      .then((r) => r.data),
};
...
export const maintenanceApi = {
  ...
  report: (params) =>
    api.get("/maintenance/report", { params }).then((r) => r.data),
  reminders: (params) =>
    api.get("/maintenance/reminders", { params }).then((r) => r.data),
};
